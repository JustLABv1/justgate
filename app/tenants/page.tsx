      ...
      <div className="space-y-6">
        ...
        {result.data.length === 0 ? (
          <div className="empty-state">
            <div className="empty-state__title">No tenants configured</div>
            <div className="empty-state__copy">
              Create the first tenant boundary to define upstream destinations and identity headers for your proxy routes.
            </div>
          </div>
        ) : (
