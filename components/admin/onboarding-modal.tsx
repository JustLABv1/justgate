                  ...
                  <div className="space-y-6">
                    ...
                    {issuedToken ? (
                      <div className="enterprise-feedback enterprise-feedback--success space-y-4 p-6">
                        ...
                        <div className="space-y-2">
                           <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Secret Key (Save this now!)</p>
                           <div className="rounded-xl bg-background border border-border p-4 font-mono text-sm break-all select-all">
                             {issuedToken.secret}
                           </div>
