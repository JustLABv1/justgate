...
import { ArrowRight, Copy, Shield, Terminal, Waypoints } from "lucide-react";
  ...
  if (routes.length === 0) {
    return (
      <div className="empty-state">
        ...
        <div className="empty-state__title">No proxy entry points exist yet.</div>
        <div className="empty-state__copy">
          Create a route after defining a tenant boundary.
        </div>
      </div>
    );
  }
